...
void initData(){
    ...
    while(getline(file, usn, '.')){
        ...
        getline(file, nsai, '.');
        Account p;
        p.creatData(usn, id, pw, stoi(sodu), stoi(nsai));
                        ...
                        switch(chon){
                            ...
                            case 2:
                                ...
                                for(int j = 0; j < list_account.size(); j++){
                                    if( idK == list_account.at(j).getID()){
                                        cout<<"\n     Ban co chac muon chuyen tien den ten tai khoan: "<< list_account.at(j).getUsername()<<" khong?\n";
                                        cout<<"\n1.Co\n2.Khong va quay lai.\n\n";
                                        int x;
                                        cin>>x;
                                        if( x==2) goto MENU;
